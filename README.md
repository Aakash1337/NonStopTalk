...
- Separately review a single-version production exact-outbox activation now that the staging rollback/drain/restoration proof and repeated exact smoke have passed; staging is healthy `durable-outbox`, while production remains `best-effort`
