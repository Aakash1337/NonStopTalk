...
- Complete the pending staging rollback/drain/candidate-restoration proof and repeat the healthy exact smoke before a separately reviewed single-version production activation; ordinary deployment propagation is protected by the Release-A-compatible one-header ownership sentinel, while intentional traffic splitting remains outside the rollout plan
