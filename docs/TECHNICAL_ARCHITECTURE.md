...
- Coaching verification: 34 Node tests for the deterministic engine and practice loop, a Playwright SPA smoke flow asserting no coaching-data API request on the default/off path, and separate cloud-progress/platform tests for the allowlist, APIs, ownership, retention, and analytics
