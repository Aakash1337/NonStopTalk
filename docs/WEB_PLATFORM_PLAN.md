...
- **Proved in staging:** exact `outbox` passed rollback-to-Release-A drain, independent legacy control, candidate restoration, and repeated exact smoke on 2026-09-02. A production cutover remains a separate review; production is still `best-effort`.
