...
`*.test.mjs` paths from both deployments; each live row negatively verifies
every discovered excluded path resolves to protected HTML rather than executable
JavaScript.
