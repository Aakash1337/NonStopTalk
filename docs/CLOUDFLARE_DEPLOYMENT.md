...
- a central D1 database for consented compact summaries, anonymous expiry, room facts, and queryable best-effort daily analytics rollups
...
- A Wrangler secret named `ANALYTICS_ADMIN_TOKEN` (24–1,024 UTF-8 bytes) for the protected aggregate analytics endpoint
